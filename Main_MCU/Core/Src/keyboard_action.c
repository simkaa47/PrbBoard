...
// 5. Управление
const char parControl[] = {0x35, 0x2E, 0xD3, 0xEF, 0xF0, 0xE0, 0xE2, 0xEB, 0xE5, 0xED, 0xE8, 0xE5,  0x00};
// Локальное
...
Error_Indication_Struct errors_info[12];
...
Row probotbor_parameters[] = {
		...
		},
		{
				.name = parControl,
				.isEdited = 1,
				.data = (uint8_t*)(&settings.retain.remote_mode),
				.isEnum = 1,
				.name_len = sizeof(parControl),
				.param_pos = 2,
				.enums = controls,
