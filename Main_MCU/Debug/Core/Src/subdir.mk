...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/analog.d ./Core/Src/analog.o ./Core/Src/control_bit.d ./Core/Src/control_bit.o ./Core/Src/dio.d ./Core/Src/dio.o ./Core/Src/ethernet_task.d ./Core/Src/ethernet_task.o ./Core/Src/fram.d ./Core/Src/fram.o ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/keyboard.d ./Core/Src/keyboard.o ./Core/Src/keyboard_action.d ./Core/Src/keyboard_action.o ./Core/Src/lcd.d ./Core/Src/lcd.o ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main_process.d ./Core/Src/main_process.o ./Core/Src/modbus.d ./Core/Src/modbus.o ./Core/Src/probotbornik.d ./Core/Src/probotbornik.o ./Core/Src/settings.d ./Core/Src/settings.o ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/timer.d ./Core/Src/timer.o ./Core/Src/uart_task.d ./Core/Src/uart_task.o ./Core/Src/universal_control.d ./Core/Src/universal_control.o ./Core/Src/vozvratKovshaFb.d ./Core/Src/vozvratKovshaFb.o
